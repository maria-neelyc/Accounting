...
Begin Report
    ...
    Filter ="(Bal <> 0 OR openbalDR <> 0 or openbalCR <> 0)"
    ...
    PrtMip = Begin
        0x3702000037020000370200003702000000000000da290000f400000001000000 ,
        ...
        Begin BreakFooter
            ...
            Begin
                Begin TextBox
                    ...
                    Width =1134
                    Name ="TotalDR"
                    ControlSource ="=Sum([trnsDebits])+[OpenBalDR]"
                    Format ="Standard"
                End
                Begin TextBox
                    DecimalPlaces =2
                    ...
                    TabIndex =1
                    Name ="TotalCR"
                    ControlSource ="=Sum([trnsCredits])+[OpenBalCR]"
                    Format ="Standard"
                End
                Begin Label
                    FontItalic = NotDefault
