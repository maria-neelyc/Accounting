dbMemo "SQL" ="SELECT Sum(tblTransactionSub.trnsCredits) AS CR, Sum(tblTransactionSub.trnsDebit"
    ...
    "action.trnYear)=tblControl.yearID))\015\012GROUP BY tblAccount.accID, tblAccount"
    ".caoID, tblAccount.accNo, tblAccount.accName, tblAccount.accOpenBalance;\015\012"
dbMemo "Connect" =""
