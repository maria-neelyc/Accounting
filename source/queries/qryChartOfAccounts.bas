dbMemo "SQL" ="SELECT tblChart.coaID, tblChart.coaNo, tblAccount.accNo, tblChart.coaName AS coa"
    ...
    "LEFT JOIN tblAccount ON tblChart.coaID=tblAccount.caoID\015\012WHERE (((tblChart"
    ".lvlID)<=Forms.frmReport.txtToStr1))\015\012ORDER BY tblChart.coaRef1, tblChart."
    "coaRef2, tblChart.coaRef3, tblChart.coaRef4, tblChart.coaRef5;\015\012"
dbMemo "Connect" =""
