        ...
        Begin FormHeader
            ...
            Begin
                Begin Image
                    ...
                    Name ="imgHeader"
                    PictureData = Begin
                        0x03000000c402330108000000c9050000450500005d1126cf010009000003a809 ,
            ...
            Begin
                Begin ComboBox
                    ...
                    RowSource ="SELECT tblChart.coaID, tblChart.coaName, tblChart.coaNo, tblChart.coaIDg, tblCha"
                        ...
                        "\"00\" & tblChart.coaRef5,3) AS coaRef FROM tblChart WHERE (((tblChart.coaIDg)=["
                        "coaID])); "
                    ColumnWidths ="0;2882;0;0;0"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblChart.coaID, tblChart.coaName, tblChart.coaNo, tblChart.coaIDg, tblCha"
                        "rt.lvlID, tblChart.coaRef2 FROM tblChart WHERE (((tblChart.coaIDg)<>[coaID] And "
                        "(tblChart.coaIDg)=1)); "
                    ColumnWidths ="0;2882;0;0;0"
                    OnChange ="[Event Procedure]"
                End
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblChart.coaID, tblChart.coaName, tblChart.coaNo, tblChart.coaIDg, tblCha"
                        "rt.lvlID, tblChart.coaRef3 FROM tblChart WHERE (((tblChart.coaIDg)<>[coaID] And "
                        "(tblChart.coaIDg)=5)); "
                    ColumnWidths ="0;2884;0;0;0"
                    OnChange ="[Event Procedure]"
                End
                Begin Label
                    OverlapFlags =95
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblChart.coaID, tblChart.coaName, tblChart.coaNo, tblChart.coaIDg, tblCha"
                        "rt.lvlID, tblChart.coaRef4 FROM tblChart WHERE (((tblChart.coaIDg)<>[coaID] And "
                        "(tblChart.coaIDg)=5)); "
                    ColumnWidths ="0;2882;0;0;0"
                    OnChange ="[Event Procedure]"
                End
                ...
                Begin CommandButton
                    ...
                    PictureData = Begin
                        ...
                        0xadadadadadadadaddadada00dadadadaadadad00adadadaddadada00dadadada ,
                        0xada00000000dadaddad00000000adadaadadad00adadadaddadada00dadadada ,
                        0xadadad00adadadaddadadadadadadada0d0dadadadad0d0d0a0adadadada0a0a ,
                        0x0d0dadadadad0d0d
                    End
                    ObjectPalette = Begin
                        ...
                        0xffffff0000000000
                    End
                    ControlTipText ="Add last (4th) level\015\012"
                End
                Begin CommandButton
                    OverlapFlags =247
                    Left =4935
